      ...
      <div className="h-screen container mx-auto flex  items-center justify-center text-white">
        ...
        <header className="absolute top-0 left-0 w-full flex justify-between items-center p-5  ">
          ...
          <div className="flex items-center space-x-4">
            <Link
              to={"/admin/signup"}
              className="bg-white font-medium text-black py-2 px-4 rounded-md"
            >
              Signup
            </Link>
          </div>
        ...
        <div className="bg-gray-900 p-8 rounded-lg shadow-lg w-[500px] mt-20">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="w-full mt-4 bg-white hover:bg-black text-black hover:text-white font-medium py-3 px-6 rounded-md transition"
            >
              Login
            </button>
          </form>
