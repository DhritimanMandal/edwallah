    ...
    <div className="flex h-screen bg-gradient-to-r from-black to-blue-950 ">
      ...
      <div className="w-64 bg-gray-800 p-5">
        <div className="flex items-center flex-col mb-10">
          ...
          <h2 className="text-lg text-white font-semibold mt-4">I'm Admin</h2>
        </div>
      ...
      <div className="flex h-screen items-center text-xl text-white md:text-4xl justify-center ml-[10%] md:ml-[25%]">
