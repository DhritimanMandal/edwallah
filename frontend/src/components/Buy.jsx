      ...
      {error ? (
        ...
        <div className="flex flex-col sm:flex-row my-40 container mx-auto">
          <div className="w-full md:w-1/2">
            <h1 className="mt-20 text-center sm:text-left text-xl font-semibold underline">Order Details</h1>
            <div className="flex items-center text-center space-x-2 mt-4">
              <h2 className="text-gray-600 text-sm text-center ml-40 sm:ml-0">Total Price :</h2>
              <p className="text-black font-bold">₹{course.price}</p>
            </div>
            <div className="flex items-center text-center space-x-2">
              <h1 className="text-gray-600 text-sm text-center ml-40 sm:ml-0">Course name :</h1>
