...
function Courses() {
  ...
  return (
    <div className="flex">
      ...
      <button
        className="md:hidden fixed top-11 left-4 z-20 text-3xl text-gray-800"
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-screen bg-gray-100 w-64 p-8 transform z-10 transition-transform duration-300 ease-in-out ${
      ...
      <main className="ml-0 md:ml-5 w-full bg-white p-10">
        <header className="flex justify-between items-center mb-10">
          <h1 className="text-white md:text-3xl md:text-black font-extrabold">Engineering Drawings</h1>
              ...
              {courses.map((course) => (
                ...
                >
                  <img
                    ...
                    alt={course.title}
                    className="rounded mb-4 h-60 w-full object-contain"
                  />
                  ...
                  <div className="flex justify-between items-center mb-4">
                    <span className="font-bold text-xl">
                      ₹{course.price}{" "}
                      <span className="text-gray-500 line-through">100000</span>
                    </span>
