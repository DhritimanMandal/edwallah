      ...
      <div className="h-screen container mx-auto flex  items-center justify-center text-white">
        ...
        <header className="absolute top-0 left-0 w-full flex justify-between items-center p-5  ">
          ...
          <div className="flex items-center space-x-4">
            <Link
              to={"/login"}
              className="font-medium bg-white text-black p-1 text-sm md:text-md md:py-2 md:px-4 rounded-md"
            >
              Login
            </Link>
          </div>
        ...
        <div className="bg-gray-900 p-8 rounded-lg shadow-lg w-[500px] m-8 md:m-0 mt-20">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="w-full font-medium bg-white hover:bg-black text-black hover:text-white py-3 px-6 mt-2 rounded-md transition"
            >
              Signup
            </button>
          </form>
